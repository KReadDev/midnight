...
//  private String sitelink, id;
//  private SiteManga manga;
...
//        Element info = ScrapperFunctions.getElementAtIndex(doc,"class","info",0);
  ...
  private void runInThread(String sitelink, String id, SiteManga manga) {
    ...
    for (DownloadData download : instance.downloads) {
      if(Objects.equals(dl.mangaId, download.mangaId)){
        return;
      }
    }
...
//      FileOutputStream outputStream = new FileOutputStream(pathname+"/pogress.txt");
